...
# ====================== PARTIE AJOUTEE/MODIFIEE =========================================    
        # Mesure de la distance de l'obstacle par le capteur VL6180X
        distance = telemetre.get_distance()
        if distance > 0 :
            print("%d mm, %d cm" % (distance, (distance/10)))
            if distance > 100 :
                distance = 100
            # Allume le nombre de LEDs correspondant au niveau demandé
            bargraphe.afficher(int(distance/10))
            # Afficher le niveau lu sur le bargraphe
            print("Niveau lu : {}".format(bargraphe.lire()))
...
# ===================== POUR AJUSTER LA DIFFICULTE DU JEU  ===============================
